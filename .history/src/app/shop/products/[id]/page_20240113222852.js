...
import ReviewsStatictic from "@/app/shop/products/Card/ReviewsStatictic";
import Specification from "@/app/shop/products/Card/Specification";
import Description from "@/app/shop/products/Card/Details";
import Reviews from "@/app/shop/products/Card/Reviews";
                ...
                <div className='grid grid-cols-2'>
                    <div className='flex items-center w-full'>
                        ...
                        >
                            <Image
                                ...
                                src={currentImage ? localURL+currentImage : localURL +  product.cover} alt="" width={1280} height={729} />
                        </div>
                            ...
                            >
                                {
                                    product?.images?.map((img , index) => (
                                        <SwiperSlide>
                                            <Thumb image={img.image} setCurremtImage={setCurrentImage} />
                                        </SwiperSlide>
                                    ))
                                }
                    ...
                    <div className="p-5 w-full">
                        ...
                        <div className="mt-4 flex item-center">
                            ...
                            <h2><span className="text-neutral-900 text-lg font-bold ">{product?.available}</span><span className="text-neutral-900 text-lg font-normal "> Sold</span></h2>
                            <div className="w-0.5 h-[31px] bg-zinc-100 rounded-[22px] mx-3" />
                            <span className='mt-[5px]'>
                                <Eye />
                            </span>
                            <div className="ml-4"><span className="text-neutral-900 text-lg font-bold">{product?.visit} </span><span className="text-neutral-900 text-lg font-normal ">Viewed</span></div>
                        </div>
                        <div className="flex justify-between mt-10">
                            <div className=' flex item-center'>
                                ...
                                <button className='bg-green-500 text-white mt-2 text-xs w-[45px] rounded-lg h-[26px] font-semibold ml-4'>{product?.discount_percentage}%</button>

                            </div>
                            {
                                product.brand && <Image src={'/images/store.png'} width={120} height={30} alt={""}/>
                            }
                        </div>
                                ...
                                <div className={"ml-4"}>
                                    {
                                        product?.variant?.map((vari , key) => (
                                            ...
                                            className={`btn bg-${vari} text-white uppercase`}>{vari}</button>
                                        ))
                                    }
                                </div>
                            </div>
                ...
                <div className={"flex items-start"}>
                    ...
                    <section className={"ml-10 w-full"}>
                        ...
                        <div>
                            ...
                            {
                                activeTab === "description" && <Description data={product?.descriptions}/>
                            }{
...
const Thumb = ({setCurremtImage , image}) => {
    return (
        <div onClick={() => setCurremtImage(image)}
