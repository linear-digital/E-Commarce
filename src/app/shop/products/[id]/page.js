...
import {addToCartHandler} from "@/redux/helper/addtoCart";
      ...
      <section className="container mx-auto mt-10 shadow-lg pb-5">
        <div className="grid grid-cols-2">
          <div className="flex items-center w-full justify-center">
            <div
              className={`image-container relative w-auto max-w-[504px] overflow-hidden  bg-stone-100 rounded-md ${
                zoom ? "zoomed" : ""
              }`}
              // style={{
            ...
            >
              {
                currentImage.video ?
                    <>
                      <video className={"w-full min-w-[504px]"} autoPlay>
            ...
            <div className="h-[529px] min-w-[80px] max-w-[92px] ml-3 flex items-center justify-center flex-col">
