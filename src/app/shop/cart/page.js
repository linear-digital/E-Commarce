                ...
                <div className={"grid grid-cols-10 w-full mt-10 gap-10"}>
                                ...
                                <tbody>
                                    {
                                        ...
                                        <td className='text-center text-primary font-semibold text-3xl pt-10'>
                                            <Link  href={'/shop/categories'}>Continue Shopping</Link>
                                        </td>
                                        :
                                        carts?.map((car , index) => (
                                            <CartCard
                    ...
                    <div className={"col-span-4"}>
                        ...
                        <div className="w-[100%] mt-10 min-h-[314px] bg-white rounded-xl p-10 border border-neutral-300">
                            ...
                            <Link href={checkOut.length > 0 ? "/shop/checkout" : "/shop/cart"} className={"btn btn-primary w-full mt-10"}>Checkout</Link>
                            <Link href={"/shop/categories"} className="text-orange-500 text-center flex justify-center w-full mt-5 text-base font-bold">Back to Shopping</Link>
                        </div>
                    </div>
                </div>
            </div>
