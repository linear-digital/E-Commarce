        ...
        <>
            {
                type === "list" ?
                    ...
                    :
                    <div className="lg:max-w-[273px] cursor-pointer max-w-[170px] max-h-[490px]  lg:min-w-[273px] lg:min-h-[420px] pb-4  bg-white rounded-[20px] overflow-hidden shadow-xl shadow-stone-100">
